...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">DRIBBLE SHOES CORNER </a>
    ...
    <div class="container mt-4">
        ...
        <div class="row gallery-section">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="seven.png" class="card-img-top gallery-img" alt="Design Thumbnail">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 col-sm-6 mb-4">
                <div class="card shadow gallery-item">
                    <img src="eig.png" class="card-img-top gallery-img" alt="Design Thumbnail">
                    <div class="card-body text-center">
    ...
    <footer class="bg-dark text-white text-center py-3">
        <p>© Dribbble. All rights reserved.<br>Designed By IJAS J[25007615]</p>
    </footer>
...
body {
    ...
    color: #00eaff; /* Dark, contrasting text */
}
